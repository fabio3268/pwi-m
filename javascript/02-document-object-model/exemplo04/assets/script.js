...
// Depois veremos uma forma melhor
document.querySelector(".inside.one").innerHTML = "Primeiro";
document.querySelector(".inside.two").innerHTML = "Segundo";
document.querySelector(".inside.three").innerHTML = "Terceiro";