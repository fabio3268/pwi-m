...
// UPDATE na tabele destino no atributo image
// retirar os três primeiros caracteres do nome do arquivo
$fileName = substr($targetFile, 3); // para gravar no banco de dados
//echo $fileName;
